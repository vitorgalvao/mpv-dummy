...
mpv DUMMY is a macOS app created with [Platypus](https://sveinbjorn.org/platypus). All it does is take your files and pass them along to the Homebrew-installed mpv command-line, providing the best of both worlds.
